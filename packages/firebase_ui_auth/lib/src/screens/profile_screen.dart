...
import 'package:firebase_auth/firebase_auth.dart'
    show ActionCodeSettings, FirebaseAuth, FirebaseAuthException, MultiFactorInfo, PhoneAuthCredential, PhoneMultiFactorGenerator, User;
import 'package:firebase_ui_auth/firebase_ui_auth.dart';
import 'package:firebase_ui_localizations/firebase_ui_localizations.dart';
import 'package:firebase_ui_oauth/firebase_ui_oauth.dart' hide OAuthProviderButtonBase;
...
class _LinkedProvidersRowState extends State<_LinkedProvidersRow> {
              ...
              child: Align(
                ...
                child: GestureDetector(
                  ...
                  child: Transform.translate(
                    ...
                    child: Icon(
                      isCupertino ? CupertinoIcons.minus_circle_fill : Icons.remove_circle,
                      size: 20,
  ...
  Widget build(BuildContext context) {
    final l = FirebaseUILocalizations.labelsOf(context);
    Widget child = Row(
      children: [for (var provider in widget.providers) buildProviderIcon(context, provider.providerId)]
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Subtitle(
                    text: state == EmailVerificationState.sent || state == EmailVerificationState.pending
...
class ProfileScreen extends MultiProviderScreen {
  ...
  List<AuthProvider> getAvailableProviders(BuildContext context, User user) {
    ...
    return providers
        .where(
          (provider) => !user.isProviderLinked(provider.providerId) && provider.supportsPlatform(platform),
        )
        .toList();
  }
